...
namespace DBCompare.Xml.Parsers
{
    ...
    public partial class CheckConstraintsParser : ParserBaseClass
    {
        ...
        #region Events
            ...
            #region Parsing(XmlNode xmlNode, ref CheckConstraint checkConstraint)
            /// <summary>
            ...
            /// <returns>True if cancelled else false if not.</returns>
            public bool Parsing(XmlNode xmlNode, ref CheckConstraint checkConstraint)
            {
                // initial value
                bool cancel = false;
            ...
            #region Parsed(XmlNode xmlNode, ref CheckConstraint checkConstraint)
            /// <summary>
