...
namespace DBCompare.Xml.Parsers
{
    ...
    public partial class IndexesParser : ParserBaseClass
    {
        ...
        #region Events
            ...
            #region Parsing(XmlNode xmlNode, ref DataIndex dataIndex)
            /// <summary>
            ...
            /// <returns>True if cancelled else false if not.</returns>
            public bool Parsing(XmlNode xmlNode, ref DataIndex dataIndex)
            {
                // initial value
                bool cancel = false;
            ...
            #region Parsed(XmlNode xmlNode, ref DataIndex dataIndex)
            /// <summary>
